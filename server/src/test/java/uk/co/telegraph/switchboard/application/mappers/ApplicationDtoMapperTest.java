...
class ApplicationDtoMapperTest {
  ...
  void setUp() {
    ...
    applicationDtoMapper = Mappers.getMapper(ApplicationDtoMapper.class);
  }

  @Test
  void should_map_from_domain_to_dto() {
    ApplicationDto applicationDto = applicationDtoMapper.domainToDto(application);
  ...
  void should_return_null_dto_if_domain_is_null() {
    ApplicationDto applicationDto = applicationDtoMapper.domainToDto(null);
  ...
  void should_update_domain_with_request_dto() {
    ...
    applicationDtoMapper.updateDomainFromDto(applicationCreateDto, application);
  ...
  void should_not_update_domain_with_request_dto_if_dto_is_null() {
    applicationDtoMapper.updateDomainFromDto(null, application);
